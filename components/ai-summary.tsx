          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="text-sm font-medium">
                {data.generated ? `Generated by ${data.model}` : "Deterministic summary"}
              </div>
            </div>
          </div>
          {!data.generated && (
            <div className="text-[10px] text-muted-foreground hidden sm:block max-w-[48%] text-right">
              Add OPENAI_API_KEY to enable LLM narrative
            </div>
          )}
        </div>
